...
{
    public class EstabelecimentoPreferencias
    {

        public EstabelecimentoPreferencias(Preferencia preferencia, Estabelecimento estabelecimento, Boolean aprovado)
        {
        ...
        protected EstabelecimentoPreferencias()
        {
        }
